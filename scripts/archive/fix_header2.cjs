...
const regex = /<div className="flex items-center gap-2 order-3 sm:order-2 overflow-x-auto no-scrollbar max-w-full">[\s\S]*?<\/div>\s*<\/div>\s*<\/div>\s*\{\/\* Header Right Actions: Fullscreen Focus \+ Close \*\/\}/;
